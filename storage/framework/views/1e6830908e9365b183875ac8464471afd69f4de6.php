            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Agro-Retailers</p>
                      <p class="card-title">214<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Produce Buyers</p>
                      <p class="card-title">87<p>
                    </div>
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\OneDrive\Desktop\EmaishaDesk\emaishapp\resources\views/home.blade.php ENDPATH**/ ?>